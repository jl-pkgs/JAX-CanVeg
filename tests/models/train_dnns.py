...
site, key = "US-Whs", "dl"
f_forcing_train = dir_root / f"data/fluxtower/{site}/{site}-forcings.csv"
f_obs_train = dir_root / f"data/fluxtower/{site}/{site}-fluxes.csv"
f_forcing_test = dir_root / f"data/fluxtower/{site}/{site}-forcings-test.csv"
f_obs_test = dir_root / f"data/fluxtower/{site}/{site}-fluxes-test.csv"
